...
export ALLOCATION_NAME="allocation-${CLUSTER_NAME}"
...
#export MASTER_MACHINE_TYPE="n1-standard-32"
...
#export MASTER_ACCELERATOR_TYPE="nvidia-tesla-a100"
#export MASTER_ACCELERATOR_TYPE="nvidia-h100-80gb"
